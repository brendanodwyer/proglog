...
func setupFlags(cmd *cobra.Command) error {
	...
	cmd.Flags().String("data-dir", dataDir, "Directory to sotre log and Raft data.")
	...
	cmd.Flags().String("acl-policy_file", "", "Path to ACL policy")
	cmd.Flags().String("server-tls-cert-file", "", "Path to server tls certificate")
	...
	cmd.Flags().String("peer-tls-cert-file", "", "Path to peer tls certificate")
